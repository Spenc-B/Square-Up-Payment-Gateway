<?php
/**
 * Plugin Name: Square Web Payments for WooCommerce
...
add_action('plugins_loaded', 'SWP_Init');
function SWP_Init() {
    if (!class_exists('WC_Payment_Gateway')) return;

    include_once plugin_dir_path(__FILE__) . 'class-square-payments-gateway.php';

    add_filter('woocommerce_payment_gateways', function ($methods) {
        $methods[] = 'Square_Payments_Gateway';
        return $methods;
    });
}
...
// Add express container before payment section
